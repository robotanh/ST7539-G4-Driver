...
// 5x7 punctuation (bit-reversed versions)
static const uint8_t FONT5x7_COLON[5]  = {0x00,0x6C,0x6C,0x00,0x00}; // :
static const uint8_t FONT5x7_DOT[5]    = {0x00,0x06,0x06,0x00,0x00}; // .
static const uint8_t FONT5x7_COMMA[5]  = {0x00,0x01,0x06,0x00,0x00}; // ,
static const uint8_t FONT5x7_DASH[5]   = {0x10,0x10,0x10,0x10,0x10}; // -
static const uint8_t FONT5x7_UNDER[5]  = {0x02,0x02,0x02,0x02,0x02}; // _
static const uint8_t FONT5x7_SLASH[5]  = {0x04,0x08,0x10,0x20,0x40}; // /
static const uint8_t FONT5x7_PLUS[5]   = {0x10,0x10,0x7C,0x10,0x10}; // +
static const uint8_t FONT5x7_EXCL[5]   = {0x00,0x00,0xFA,0x00,0x00}; // !
static const uint8_t FONT5x7_QMARK[5]  = {0x40,0x80,0x8A,0x90,0x60}; // ?
static const uint8_t FONT5x7_PERC[5]   = {0x46,0x26,0x10,0xC8,0xC4}; // %
static const uint8_t FONT5x7_LPAREN[5] = {0x00,0x38,0x44,0x82,0x00}; // (
static const uint8_t FONT5x7_RPAREN[5] = {0x00,0x82,0x44,0x38,0x00}; // )
